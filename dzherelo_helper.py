...
def dzherelo_convertdate(isodate):
...
def convert_dzherelo_date_to_iso_format(date_time_from_ui):
...
def dzherelo_download_file(url, file_name, output_dir):
    urllib.urlretrieve(url, ('{}/{}'.format(output_dir, file_name)))

def convert_dzherelo_string(string):
    return {
            'True':                                                 '1',
            'False':                                                '0',
            u"Так":                                                 True,
